...
keys.forEach((key) => {
  key.addEventListener("mousedown", function () {
    ...
    if (keyText === "a".toUpperCase()) play("./piano-notes/4-c-cut.mp3");
    if (keyText === "s".toUpperCase()) play("./piano-notes/4-d-cut.mp3");
    if (keyText === "d".toUpperCase()) play("./piano-notes/4-e-cut.mp3");
    if (keyText === "f".toUpperCase()) play("./piano-notes/4-f-cut.mp3");
    if (keyText === "g".toUpperCase()) play("./piano-notes/4-g-cut.mp3");
    if (keyText === "h".toUpperCase()) play("./piano-notes/4-a-cut.mp3");
    if (keyText === "j".toUpperCase()) play("./piano-notes/4-b-cut.mp3");
    if (keyText === "k".toUpperCase()) play("./piano-notes/5-c-cut.mp3");
    if (keyText === "l".toUpperCase()) play("./piano-notes/5-d-cut.mp3");
    if (keyText === ";".toUpperCase()) play("./piano-notes/5-e-cut.mp3");
    // Top row
    if (keyText === "w".toUpperCase()) play("./piano-notes/4-cs-cut.mp3");
    if (keyText === "e".toUpperCase()) play("./piano-notes/4-ds-cut.mp3");
    if (keyText === "t".toUpperCase()) play("./piano-notes/4-fs-cut.mp3");
    if (keyText === "y".toUpperCase()) play("./piano-notes/4-gs-cut.mp3");
    if (keyText === "u".toUpperCase()) play("./piano-notes/4-as-cut.mp3");
    if (keyText === "i".toUpperCase()) play("./piano-notes/5-bs-cut.mp3");
    if (keyText === "o".toUpperCase()) play("./piano-notes/5-cs-cut.mp3");
    if (keyText === "p".toUpperCase()) play("./piano-notes/5-ds-cut.mp3");
  });
